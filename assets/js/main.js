...
function setActiveNavLink() {
  ...
  sections.forEach(section => {
    const sectionTop = section.offsetTop - 150; // Offset pour ajuster le décalage (peut être modifié)
...
// Exécute une vérification lors du chargement initial de la page
